  ...
  const footerHTML = `
    <div class="footer-content">
      <div class="footer-links">
        <a href="mailto:emanuele.zanella@outlook.it" class="footer-link">
        ...
        <a href="https://linkedin.com/in/emanuele-zanella-299ba01a9" target="_blank" rel="noopener noreferrer" class="footer-link">
      ...
      <div class="footer-copy">
        © ${currentYear} Emanuele Zanella. Tutti i diritti riservati.
      </div>
    </div>`;
